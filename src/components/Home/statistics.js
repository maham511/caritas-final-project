  ...
  return (
    <div className="flex m-2 bg-gray-200">
      <div className="flex-1 max-w-4xl m-auto mb-6">
        ...
        <div className="grid grid-cols-1 p-2 md:gap-4 md:grid-cols-3 rounded md:text-center">
          <div className="bg-white m-2 p-4">
            <p className="text-4xl font-extrabold pb-2">87%</p>
            <p>
              Students agreed English classes helped them feel less isolated
            </p>
          </div>
          <div className="bg-white m-2 p-4">
            <p className="text-4xl font-extrabold pb-2">85%</p>
            <p>
          ...
          <div className="bg-white m-2 p-4">
            <p className="text-4xl font-extrabold pb-2">90%</p>
            <p>
